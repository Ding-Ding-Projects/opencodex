...
func sortedNames(result HostedImageGeneration) []string {
...
func TestExtractHostedImageGenerationRequiresAHostedEntry(t *testing.T) {
...
func TestExtractHostedImageGenerationNamesTheHostedEntry(t *testing.T) {
...
func TestExtractHostedImageGenerationCollectsConflictingAliases(t *testing.T) {
...
func TestExtractHostedImageGenerationHandlesMultipleAndJunkEntries(t *testing.T) {
	result, ok := ExtractHostedImageGeneration(toolList(t,
