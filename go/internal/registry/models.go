...
var providerModels = map[string][]ModelDefinition{
	...
	// BigModel's own roster. Every model carries its window explicitly: Go has
	// no jawcode-bundle resolver, so anything left blank falls back to a
	// generic 128k and starts compacting a third of the way through the real
	// 204,800-token context.
	"zhipu-bigmodel":        {{ID: "glm-4.6", ContextWindow: 204_800, ReasoningEfforts: standardReasoningEfforts}, {ID: "glm-4.7", ContextWindow: 204_800, ReasoningEfforts: standardReasoningEfforts}, {ID: "glm-4.7-flash", ContextWindow: 204_800}, {ID: "glm-5", ContextWindow: 204_800, ReasoningEfforts: standardReasoningEfforts}, {ID: "glm-5.1", ContextWindow: 204_800, ReasoningEfforts: standardReasoningEfforts}, {ID: "glm-4.6v", ContextWindow: 204_800}},
