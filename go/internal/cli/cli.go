...
func defaultCommandSpecs() []commandSpec {
	return []commandSpec{
		...
		{Name: "changelog", Usage: "ocx changelog [--json]", Summary: "Show packaged release history", Handler: noContext(runChangelog)},
		{Name: "export", Usage: "ocx export <path|->", Summary: "Export validated configuration", Handler: noContext(runExport)},
		{Name: "host", Usage: "ocx host <status|discover> [--json]", Summary: "Inspect host exposure and discovery", Handler: noContext(runHost)},
		{Name: "launch", Usage: "ocx launch [target] [--json]", Summary: "Inspect fixed launch targets", Handler: noContext(runLaunch)},
		{Name: "terminal", Usage: "ocx terminal <list> [--json]", Summary: "Inspect fixed terminal presets", Handler: noContext(runTerminal)},
		...
		{Name: "sync-cache", Usage: "ocx sync-cache [--restart-codex]", Summary: "Invalidate the Codex model cache", Handler: noContext(runSyncCache)},
		{Name: "sync", Usage: "ocx sync [--restart-codex]", Summary: "Fetch models and inject them into Codex", Handler: runSync},
