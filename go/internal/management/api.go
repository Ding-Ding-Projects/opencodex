...
var routes = []string{
	...
	"GET /api/codex-auth/accounts", "POST /api/codex-auth/accounts", "DELETE /api/codex-auth/accounts", "PUT /api/codex-auth/accounts/alias", "PUT /api/codex-auth/accounts/pause", "GET /api/codex-auth/active", "PUT /api/codex-auth/active", "PUT /api/codex-auth/auto-switch", "PUT /api/codex-auth/failover", "GET /api/codex-auth/reset-credits", "POST /api/codex-auth/reset-credits/consume", "POST /api/codex-auth/login", "POST /api/codex-auth/login/code", "POST /api/codex-auth/login/cancel", "GET /api/codex-auth/login-status",
	...
	"GET /api/logs", "GET /api/debug", "PUT /api/debug", "GET /api/debug/usage-logs", "GET /api/usage", "GET /api/storage", "POST /api/storage/cleanup/preview", "GET /api/storage/trash", "GET /api/storage/cleanup-policy", "PUT /api/storage/cleanup-policy", "GET /api/storage/cleanup-policy/test-stream", "GET /api/storage/trash/restore/test-stream",
