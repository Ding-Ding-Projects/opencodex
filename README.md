...
- **Runs in the background.** Install as a Windows Task Scheduler service (hidden) and forget about it, or use `ocx service install --native` for a real Windows service that starts at boot.
