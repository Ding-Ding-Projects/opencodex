...
agent working in this checkout does not have to guess at it. Sanitized: nothing
machine-, host- or account-specific appears below. It is a **copy** — edits belong
in the canonical instructions repository first, and changing this file propagates
nowhere. Where this mirror and a rule above disagree about this repository
specifically, the repository-local rule wins.
