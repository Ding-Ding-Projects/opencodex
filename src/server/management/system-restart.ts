...
/** Restart after another route has already completed its own drain. */
export function acceptSystemRestartAfterExternalDrain(
  io: SystemRestartIo = restartIo,
): ReturnType<typeof acceptSystemRestart> {
  restartAccepted = false;
