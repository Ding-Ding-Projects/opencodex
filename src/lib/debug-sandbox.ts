 ...
 * | issuing any data-plane key (generated, paired, or user-supplied) | — |
 *
 ...
 * the data-plane credential, and management authentication; the sandbox changes none.
 *
 ...
 * and the obvious way to do that — set `config.hostname = "0.0.0.0"` in memory —
  ...
  * credential for `/v1/*`. The sandbox also refuses
