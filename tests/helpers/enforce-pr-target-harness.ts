...
const DEFAULT_PR = {
  ...
  merged: false,
  locked: false,
  html_url: "https://github.com/Ding-Ding-Projects/opencodex/pull/42",
  base: { ref: "dev", sha: "a1b2c3d4e5f60718293a4b5c6d7e8f9012345678", label: "Ding-Ding-Projects:dev" },
...
function nodeLikeProcess(): Record<string, unknown> {
  ...
  return {
    ...
    env: {
      ...
      GITHUB_REPOSITORY: "Ding-Ding-Projects/opencodex",
  ...
  class Context {
    ...
    payload = {
      ...
      repository: {
        id: 987654321,
        name: "opencodex",
        full_name: "Ding-Ding-Projects/opencodex",
        default_branch: "main",
        private: false,
        owner: { login: "lidge-jun", id: 12345, type: "User" },
        html_url: "https://github.com/Ding-Ding-Projects/opencodex",
      },
