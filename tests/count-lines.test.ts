...
// same top-level, real-repository shape as before, and now finishes in a few seconds rather than
// minutes. See tests/count-lines-attribution.test.ts for the small synthetic-fixture tests that
// pin exact counts against known content instead of scanning the whole real repository.
