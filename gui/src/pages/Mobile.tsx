 ...
 * `/api/logs`; control reads `/api/host`. Those are protected management routes,
 * so a phone holding only its paired data-plane key receives an unavailable
 * state for those panels instead of being granted configuration access.
 *
 ...
 * traffic. Pairing does not grant the management token or permission to change
 * dashboard settings.
 *
