...
import {
  ...
  IconHardDrive, IconHistory, IconKey, IconLock, IconPalette, IconReceiptLong, IconRegex, IconRestartAlt, IconServer,
...
const ORDER: Page[] = [
  ...
  "appearance", "language", "regex", "changelog", "history", "notifications", "network", "authenticator", "settings", "terminal", "mobile",
];
