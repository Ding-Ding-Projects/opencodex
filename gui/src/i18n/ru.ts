...
export const ru: Record<TKey, string> = {
  ...
  "dash.noModels": "Модели не найдены. Откройте «Провайдеры», настройте или включите провайдера, затем обновите модели.",
  "dash.startProxy": "Запустить прокси",
  "dash.proxyStarting": "Запуск…",
  "dash.proxyStarted": "Прокси запущен",
  "dash.proxyStartedBody": "Слушает на :{port}.",
  "dash.proxyAdopted": "Уже работал на :{port} — подключились снова.",
  "dash.proxyStartFailed": "Не удалось запустить прокси",
  ...
  "pws.auth.vertexExternal": "Аутентификация Vertex (ADC или необязательный API-ключ)",
  ...
  "api.authChatCompletions": "На loopback Chat Completions и /v1/models принимают Authorization: Bearer ocx_..., x-api-key или x-opencodex-api-key. Для Chat-запросов не с loopback требуется x-opencodex-api-key.",
  ...
  "api.copyUnavailable": "Буфер обмена недоступен",
  "api.colPurpose": "Назначение",
  "api.genericKeyPurpose": "Общий доступ по API",
  "api.copilotKeyPurpose": "GitHub Copilot Desktop",
  "api.copilotEyebrow": "Профиль OpenAI-совместимого клиента",
  "api.copilotTitle": "GitHub Copilot Desktop",
  "api.copilotSubtitle": "Подключите GitHub Copilot Desktop ко всем моделям, которые OpenCodex может безопасно маршрутизировать через Chat Completions.",
  "api.copilotVerifiedClient": "Проверенный контракт настройки: GitHub Copilot 1.1.4 Custom endpoint.",
  "api.copilotInboundDistinction": "Это входящий клиентский профиль: GitHub Copilot Desktop обращается к OpenCodex. Он отделён от экспериментального неофициального исходящего провайдера подписки GitHub Copilot.",
  "api.copilotCopyBaseUrl": "Копировать базовый URL GitHub Copilot Desktop",
  "api.copilotCopyModelsEndpoint": "Копировать endpoint моделей GitHub Copilot Desktop",
  "api.copilotCopyChatEndpoint": "Копировать endpoint Chat Completions GitHub Copilot Desktop",
  "api.copilotBaseUrl": "Базовый URL (включая /v1)",
  "api.copilotWireApi": "Wire API",
  "api.copilotModelsEndpoint": "Синхронизация моделей",
  "api.copilotChatEndpoint": "Чат",
  "api.copilotOptionalKey": "На loopback поле API-ключа GitHub Copilot Desktop можно оставить пустым. Выделенный ключ интеграции усиливает изоляцию локальных клиентов; OpenCodex никогда не пересылает его провайдеру.",
  "api.copilotCustomHeaders": "Если выделенный ключ используется через Custom headers, задайте x-opencodex-api-key равным созданному значению. Никогда не помещайте ключ в базовый URL.",
  "api.copilotGenerateKey": "Создать ключ интеграции",
  "api.copilotManageKey": "Управление или отзыв ключа",
  "api.copilotKeyName": "GitHub Copilot Desktop",
  "api.copilotRevealAbove": "Новый ключ будет показан один раз в панели под этой карточкой.",
  "api.copilotStatusReady": "Готово к настройке",
  "api.copilotStatusWaiting": "Ожидание первого запроса",
  "api.copilotStatusObserved": "Последний запрос: HTTP {status} · {time}",
  "api.copilotStatusUnavailable": "Статус готовности недоступен",
  "api.copilotReadyModels": "Готово моделей: {count}",
  "api.copilotProviderCount": "Проверено провайдеров: {count}",
  "api.copilotDirectTitle": "OpenAI Direct исключён",
  "api.copilotDirectWarning": "Используйте управляемый режим OpenAI Pool. Bearer клиента предназначен для локального допуска и никогда не используется как учётные данные OpenAI для провайдера.",
  "api.copilotSidecars": "Sidecar для зрения и веб-поиска запускаются только при настройке и необходимости. Нативное локальное выполнение Cursor недоступно этому профилю.",
  "api.colReadiness": "Готовность Copilot",
  "api.colCapabilities": "Возможности Copilot",
  "api.capabilityReady": "Готово",
  "api.capabilityUnavailable": "Недоступно",
  "api.capabilityChat": "Чат",
  "api.capabilityAgent": "Инструменты Agent",
  "api.capabilityImages": "Изображения",
  "api.capabilityReasoning": "Рассуждение",
  "api.capabilityStructured": "Структурированный вывод",
  "api.capabilitySidecar": "Возможен sidecar",
  "api.capabilityYes": "Да",
  "api.capabilityNo": "Нет",
  "api.testUnavailable": "Модель недоступна профилю GitHub Copilot Desktop. См. причину готовности.",
  "api.reason.ready": "Готово",
  "api.reason.provider-disabled": "Провайдер отключён",
  "api.reason.missing-credential": "Требуется вход или API-ключ",
  "api.reason.needs-reauthentication": "Требуется повторная аутентификация",
  "api.reason.direct-mode-unsupported": "OpenAI Direct не поддерживается; используйте Pool",
  "api.reason.cursor-native-execution-unavailable": "Нативное локальное выполнение Cursor должно быть отключено",
  "api.reason.unresolved-route": "Маршрут не удалось определить",
  "api.reason.unsupported-adapter": "Адаптер не поддерживается",
  "api.regexBuilder": "Regex",
  "api.regexBuilderTitle": "Конструктор regex для поиска моделей",
  "api.regexClose": "Закрыть",
  "api.regexEnable": "Использовать regex в этом поиске",
  "api.regexPattern": "Шаблон",
  "api.regexGuided": "Элементы построения шаблона",
  "api.regexLiteral": "Литерал",
  "api.regexAnchors": "Якоря",
  "api.regexGroup": "Группа",
  "api.regexAlternate": "Альтернация",
  "api.regexQuantifier": "Один или больше",
  "api.regexClass": "Класс символов",
  "api.regexFlags": "Флаги",
  "api.regexSample": "Пример текста",
  "api.regexMatches": "Совпадений: {count}",
  "api.regexZeroWidth": "совпадение нулевой длины",
  "api.regexCopy": "Копировать шаблон",
  "api.regexEngine": "Движок: JavaScript RegExp. Вычисление выполняется локально и ограничено 512 символами шаблона и 4 096 символами примера.",
  "api.regexTooLong": "Шаблон должен содержать не более 512 символов.",
  "api.regexInvalid": "Шаблон недействителен.",
  // Claude Code inbound
  "nav.claude": "Claude",
  ...
  "claude.fastOn": "ВКЛ",
  "claude.fastOff": "ВЫКЛ",
  "claude.maxContext": "Переопределение размера контекста",
  "claude.maxContextDesc": "Выберите один из ограниченного набора вариантов для новых сеансов Claude Code. Автоматически использует значения клиента и модели по умолчанию; 1000000 запрашивает 1M. Сохранённое нестандартное значение остаётся доступным, пока вы его не замените.",
  "claude.maxContextWarn": "Это переопределение отключает автоматическое сжатие. Длинный чат может достичь фактического лимита контекста модели и завершиться ошибкой.",
  "claude.maxContextAutomatic": "Автоматически (по умолчанию клиента и модели)",
  "claude.maxContextDefaultProvenance": "Используется встроенное значение Автоматически; в файле конфигурации переопределение размера контекста не сохранено.",
  "claude.maxContextFileProvenance": "Сохранено в файле конфигурации opencodex для следующего сеанса Claude Code. Переменная окружения, экспортированная вручную, по-прежнему имеет приоритет.",
  "claude.maxContextDraftProvenance": "Выбор не сохранён. В файле конфигурации по-прежнему используется {value}; выберите «Сохранить», чтобы применить изменение.",
  "claude.maxContextAutomaticValue": "Автоматически",
  "claude.maxContextInvalidStoredProvenance": "В файле конфигурации задано недопустимое переопределение размера контекста. Показан режим «Автоматически»; выберите «Сохранить», чтобы удалить недопустимое значение.",
  "claude.maxContextInvalidStoredValue": "недопустимое сохранённое значение",
  ...
  "claude.autoContextInert": "Неактивно, пока задано переопределение размера контекста. Чтобы снова включить эту настройку, выберите выше «Автоматически».",
