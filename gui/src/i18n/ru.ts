...
export const ru: Record<TKey, string> = {
  ...
  "path.browseFile": "Обзор…",
  "path.browseFolder": "Выбрать папку…",
  "path.browsing": "Открывается…",
  "path.browseFailed": "Не удалось открыть выбор файлов.",
  ...
  "dash.mem.goHeap": "Куча Go (занято / всего)",
  "dash.mem.goroutines": "Горутины",
  "dash.mem.hintGo": "Диагностика среды выполнения только для чтения. Go выделяет память из одной кучи, поэтому рост резидентной памяти при неизменной куче указывает на удержанные буферы или страницы, ещё не возвращённые ОС.",
