...
export const M3_EN = {
  ...
  "auth.adminTokenPrompt": "Enter the OpenCodex management token from the proxy machine. A data-plane API key cannot authorize /api/* settings. The token stays in memory for this page and is sent only to this dashboard origin.",
  "auth.adminTokenTitle": "Management token needed",
  "auth.adminTokenLabel": "Management token",
...
export const M3_OVERRIDES: Partial<Record<Locale, Partial<Record<M3Key, string>>>> = {
  de: {
    ...
    "remote.connectTitle": "Mit einem anderen OpenCodex verbinden",
    "remote.connectDescription": "Geben Sie die IP-Adresse oder den Hostnamen des entfernten Systems ein. Der Standardport ist vorausgefüllt und kann geändert werden.",
    "remote.manualHint": "Die Erkennung sieht nur Geräte, die im lokalen Netzwerk antworten. Geben Sie die Adresse hier ein, wenn das andere System verborgen ist oder sich in einem anderen Netzwerk befindet.",
    ...
    "remote.host": "IP-Adresse oder Hostname",
    "remote.hostPlaceholder": "192.168.1.50",
    "remote.port": "Port",
    "remote.portInvalid": "Geben Sie einen Port von 1 bis 65535 ein.",
    "remote.hostInvalid": "Geben Sie eine IPv4-Adresse, IPv6-Adresse oder einen Hostnamen ein.",
    "remote.ipv4LeadingZero": "Geben Sie IPv4-Oktette ohne führende Nullen ein (zum Beispiel 10.0.0.1).",
    "remote.connect": "Verbinden",
    "remote.connectOpened": "Entferntes Dashboard geöffnet",
    "remote.popupBlocked": "Der Browser hat den Tab für das entfernte Dashboard blockiert",
    "auth.adminTokenPrompt": "Geben Sie das OpenCodex-Verwaltungstoken vom Proxy-Rechner ein. Ein Datenschicht-API-Schlüssel kann /api/*-Einstellungen nicht autorisieren. Das Token bleibt für diese Seite im Arbeitsspeicher und wird nur an diesen Dashboard-Ursprung gesendet.",
    "auth.adminTokenTitle": "Verwaltungstoken erforderlich",
    "auth.adminTokenLabel": "Verwaltungstoken",
    "auth.adminTokenAction": "Dieses Token verwenden",
  ...
  ko: {
    ...
    "remote.connectTitle": "다른 OpenCodex에 연결",
    "remote.connectDescription": "원격 IP 주소 또는 호스트 이름을 입력하세요. 표준 포트가 미리 입력되어 있으며 필요하면 변경할 수 있습니다.",
    "remote.manualHint": "검색은 로컬 네트워크에서 응답하는 장치만 찾습니다. 다른 장치가 숨겨져 있거나 다른 네트워크에 있으면 여기에 주소를 입력하세요.",
    ...
    "remote.host": "IP 주소 또는 호스트 이름",
    "remote.hostPlaceholder": "192.168.1.50",
    "remote.port": "포트",
    "remote.portInvalid": "1부터 65535 사이의 포트를 입력하세요.",
    "remote.hostInvalid": "IPv4 주소, IPv6 주소 또는 호스트 이름을 입력하세요.",
    "remote.ipv4LeadingZero": "IPv4 옥텟에 앞자리 0을 쓰지 마세요(예: 10.0.0.1).",
    "remote.connect": "연결",
    "remote.connectOpened": "원격 대시보드를 열었습니다",
    "remote.popupBlocked": "브라우저가 원격 대시보드 탭을 차단했습니다",
    "auth.adminTokenPrompt": "프록시 컴퓨터의 OpenCodex 관리 토큰을 입력하세요. 데이터 플레인 API 키로는 /api/* 설정을 인증할 수 없습니다. 토큰은 이 페이지의 메모리에만 유지되며 이 대시보드 출처로만 전송됩니다.",
    "auth.adminTokenTitle": "관리 토큰 필요",
    "auth.adminTokenLabel": "관리 토큰",
    "auth.adminTokenAction": "이 토큰 사용",
  ...
  zh: {
    ...
    "remote.connectTitle": "连接到另一台 OpenCodex",
    "remote.connectDescription": "输入远程 IP 地址或主机名。标准端口已自动填入；如果远程端使用其他端口，可以修改。",
    "remote.manualHint": "发现功能只能看到在本地网络上响应的设备。如果另一台设备被隐藏或位于其他网络，请在此输入地址。",
    "remote.directHint": "连接会在新标签页中直接打开此 HTTP 地址，不会检查代理是否在线。不会把令牌加入网址，也不会在此保存令牌；HTTP 未加密，请使用可信网络或隧道。",
    "remote.host": "IP 地址或主机名",
    "remote.hostPlaceholder": "192.168.1.50",
    "remote.port": "端口",
    "remote.portInvalid": "请输入 1 到 65535 之间的端口。",
    "remote.hostInvalid": "请输入 IPv4 地址、IPv6 地址或主机名。",
    "remote.ipv4LeadingZero": "IPv4 各段请勿使用前导零（例如 10.0.0.1）。",
    "remote.connect": "连接",
    "remote.connectOpened": "已打开远程仪表板",
    "remote.popupBlocked": "浏览器阻止了远程仪表板标签页",
    "auth.adminTokenPrompt": "请输入代理计算机上的 OpenCodex 管理令牌。数据平面 API 密钥不能授权 /api/* 设置。令牌只保存在此页面的内存中，并且只会发送到此仪表板来源。",
    "auth.adminTokenTitle": "需要管理令牌",
    "auth.adminTokenLabel": "管理令牌",
    "auth.adminTokenAction": "使用此令牌",
    "nav.primaryAria": "主导航",
    "tabs.newTab": "新标签页",
    "tabs.overflow": "所有标签页",
    "notif.dismiss": "关闭",
  ...
  ja: {
    ...
    "nav.history": "バージョン履歴",
    "nav.notifications": "通知",
    "remote.connectTitle": "別の OpenCodex に接続",
    "remote.connectDescription": "リモートの IP アドレスまたはホスト名を入力してください。標準ポートは入力済みで、必要に応じて変更できます。",
    "remote.manualHint": "検出できるのはローカルネットワーク上で応答するデバイスだけです。相手が非表示または別のネットワークにある場合は、ここにアドレスを入力してください。",
    ...
    "remote.host": "IP アドレスまたはホスト名",
    "remote.hostPlaceholder": "192.168.1.50",
    "remote.port": "ポート",
    "remote.portInvalid": "1 から 65535 までのポートを入力してください。",
    "remote.hostInvalid": "IPv4 アドレス、IPv6 アドレス、またはホスト名を入力してください。",
    "remote.ipv4LeadingZero": "IPv4 の各オクテットは先頭に 0 を付けずに入力してください（例: 10.0.0.1）。",
    "remote.connect": "接続",
    "remote.connectOpened": "リモートダッシュボードを開きました",
    "remote.popupBlocked": "ブラウザーがリモートダッシュボードのタブをブロックしました",
    "auth.adminTokenPrompt": "プロキシ側のコンピューターにある OpenCodex 管理トークンを入力してください。データプレーン API キーでは /api/* の設定を認証できません。トークンはこのページのメモリにだけ保持され、このダッシュボードのオリジンにだけ送信されます。",
    "auth.adminTokenTitle": "管理トークンが必要です",
    "auth.adminTokenLabel": "管理トークン",
    "auth.adminTokenAction": "このトークンを使用",
  ...
  ru: {
    ...
    "remote.connectTitle": "Подключиться к другому OpenCodex",
    "remote.connectDescription": "Введите удалённый IP-адрес или имя хоста. Стандартный порт уже указан, но его можно изменить.",
    "remote.manualHint": "Обнаружение видит только устройства, отвечающие в локальной сети. Если другое устройство скрыто или находится в другой сети, введите его адрес здесь.",
    ...
    "remote.host": "IP-адрес или имя хоста",
    "remote.hostPlaceholder": "192.168.1.50",
    "remote.port": "Порт",
    "remote.portInvalid": "Введите порт от 1 до 65535.",
    "remote.hostInvalid": "Введите IPv4-адрес, IPv6-адрес или имя хоста.",
    "remote.ipv4LeadingZero": "Введите октеты IPv4 без ведущих нулей (например, 10.0.0.1).",
    "remote.connect": "Подключиться",
    "remote.connectOpened": "Удалённая панель открыта",
    "remote.popupBlocked": "Браузер заблокировал вкладку удалённой панели",
    "auth.adminTokenPrompt": "Введите токен управления OpenCodex с компьютера, где работает прокси. Ключ API плоскости данных не может авторизовать настройки /api/*. Токен хранится только в памяти этой страницы и отправляется только источнику этой панели.",
    "auth.adminTokenTitle": "Нужен токен управления",
    "auth.adminTokenLabel": "Токен управления",
    "auth.adminTokenAction": "Использовать токен",
