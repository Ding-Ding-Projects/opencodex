...
export const M3_EN = {
  ...
  // ---- tab groups ----
  // The header's accessible name is the group's name and its member count, and
  // never its colour or its icon: decoration must not become the only way a
  // group can be told from the one beside it.
  "tabs.groupAria": "Group {name}, {count} tabs",
  "tabs.groupMenuAria": "Actions for group {name}",
  "tabs.groupName": "Group name",
  "tabs.newGroup": "New group",
  "tabs.newGroupDefault": "New group",
  "tabs.renameGroup": "Rename group",
  "tabs.ungroup": "Ungroup — keep the tabs",
  "tabs.ungroupNamed": "Ungroup {name} — its tabs stay open",
  "tabs.expand": "Expand",
  "tabs.collapse": "Collapse",
  "tabs.expandGroup": "Expand {name}",
  "tabs.collapseGroup": "Collapse {name}",
  "tabs.groupEmpty": "Nothing in this group yet.",
  "tabs.noGroups": "No groups yet. Make one and drag tabs into it, or use Alt+Arrow.",
  "tabs.pinGroup": "Pin every tab in {name}",
  "tabs.unpinGroup": "Unpin every tab in {name}",
  "tabs.pinGroupShort": "Pin every tab in this group",
  "tabs.unpinGroupShort": "Unpin every tab in this group",
  "tabs.moveGroupEarlier": "Move {name} earlier in the strip",
  "tabs.moveGroupLater": "Move {name} later in the strip",
  "tabs.moveGroupEarlierShort": "Move group earlier",
  "tabs.moveGroupLaterShort": "Move group later",
  "tabs.moveToGroup": "Group for {name}",
  "tabs.removeFromGroup": "Take {name} out of its group",
  "tabs.editGroupAppearance": "Edit appearance of group {name}…",
  "tabs.editGroupAppearanceShort": "Edit group appearance…",
  "tabs.save": "Save",

  // ---- the group appearance editor ----
  "tabs.groupStyleFor": "Appearance for group {name}",
  // Hover and focus cannot be seen while a slider is being dragged, and
  // collapsed cannot be seen while the group is open — so all four are drawn.
  "tabs.groupStates": "Every state, at once",
  "tabs.groupStateExpanded": "Expanded",
  "tabs.groupStateCollapsed": "Collapsed",
  "tabs.groupStateHover": "Hover",
  "tabs.groupStateFocus": "Focus",
  "tabs.groupSectionText": "Name and typography",
  "tabs.groupSectionSurface": "Fills",
  "tabs.groupSectionShape": "Border, shape and spacing",
  "tabs.groupSectionShare": "Export and import",
  "tabs.groupAccent": "Group accent",
  "tabs.groupText": "Name colour",
  "tabs.groupHighlight": "Highlight behind the name",
  "tabs.groupBg": "Header fill",
  "tabs.groupCollapsedBg": "Header fill when collapsed",
  "tabs.groupHoverBg": "Header fill on hover",
  "tabs.groupFocusRing": "Focus ring",
  "tabs.groupBorder": "Border colour",
  "tabs.groupBorderWidth": "Border width",
  "tabs.groupBorderStyle": "Border style",
  "tabs.groupBorderSolid": "Solid",
  "tabs.groupBorderDashed": "Dashed",
  "tabs.groupBorderDotted": "Dotted",
  "tabs.groupRadius": "Corner radius",
  "tabs.groupPad": "Header padding",
  "tabs.groupGap": "Space to the tabs",
  "tabs.groupSeparator": "Separator before the group",
  "tabs.groupSeparatorHint": "What divides this group's run from whatever comes before it.",
  "tabs.groupSepNone": "Nothing",
  "tabs.groupSepLine": "A line",
  "tabs.groupSepSpace": "A gap",
  "tabs.groupTracking": "Letter spacing",
  "tabs.groupItalic": "Italic",
  "tabs.groupUnderline": "Underline",
  "tabs.groupCaps": "Small caps",
  "tabs.groupIcon": "Icon or emoji",
  // Said plainly, because it is the difference between decoration and a name:
  // a screen reader is given the group's name whatever is set here.
  "tabs.groupIconHint": "Shown before the name, up to two characters. Decoration only — the group is still announced by its name.",
  "tabs.groupExport": "Copy this appearance",
  "tabs.groupImport": "Paste an appearance",
  "tabs.groupTransfer": "Appearance, as text",
  "tabs.groupTransferHint": "Copy this to share it, or paste one in and apply. Anything the header cannot draw is dropped.",
  "tabs.groupTransferInvalid": "That is not readable as an appearance. Your text is kept — fix it or cancel.",
  "tabs.groupTransferApply": "Apply",

  // ---- the four tab searches ----
  "tabs.searchTitle": "Find a tab",
  "tabs.searchClose": "Close tab search",
  "tabs.searchScope": "Every search here matches a tab's visible label. Page contents are never read.",
  "tabs.searchBuilderFor": "Build a pattern for {name}",
  "tabs.stripSearch": "This strip",
  "tabs.stripSearchPh": "Text in a tab label",
  "tabs.inGroupSearch": "Inside {name}",
  "tabs.inGroupSearchPh": "Text in a tab label in this group",
  "tabs.groupSearch": "Groups by name",
  "tabs.groupSearchPh": "Text in a group name",
  "tabs.masterSearch": "Every open tab, every window",
  "tabs.masterSearchPh": "Text in any tab label anywhere",
  "tabs.masterWindows": "Covering {count} window(s) this app has open.",
  "tabs.resultCount": "{count} of {total}",
  "tabs.modePlain": "Matching as plain text — a pattern is matched literally.",
  "tabs.modeRegex": "Matching as a regular expression with flags {flags}.",
  "tabs.goTo": "Go to",
  "tabs.pinned": "Pinned",
  "tabs.ungrouped": "No group",
  "tabs.thisWindow": "This window",
  "tabs.otherWindow": "Window {n}",
  "tabs.stripName": "Strip {name}",
  // Said rather than acted on: going to a tab in a folded group reveals that one
  // tab and leaves the group folded, which is a surprise only if nobody says so.
  "tabs.collapsedNote": "In a collapsed group — going there reveals this tab without unfolding the group.",

  // ---- what the strip announces ----
  "tabs.saidWent": "Showing {name}",
  "tabs.saidClosed": "Closed {name}",
  "tabs.saidMoved": "Moved {name} into {group}",
  "tabs.saidRemovedFromGroup": "Took {name} out of its group",
  "tabs.saidGroupCreated": "Created the group {name}",
  "tabs.saidGroupPinned": "Pinned {count} tabs in {name}",
  "tabs.saidGroupUnpinned": "Unpinned {count} tabs in {name}",
  "tabs.saidUngrouped": "Removed the group {name}. Its tabs are still open.",

  // ---- the colour control ----
  "tabs.colorSpectrum": "Pick {name} from the spectrum",
  "tabs.colorMore": "More",
  "tabs.colorLess": "Less",
  "tabs.colorL": "Lightness",
  "tabs.colorC": "Chroma",
  "tabs.colorH": "Hue",
  "tabs.colorAlpha": "Opacity",
  "tabs.colorGamut": "Gamut: {gamut}",
  "tabs.colorClips": "wider than sRGB, so this screen will show the nearest colour it can",
  "tabs.colorTranslator": "The same colour in every notation",
  "tabs.colorCopy": "Copy",
  "tabs.colorCopyOne": "Copy the {space} value",
  // Reported rather than refused: a value this cannot parse may still be one the
  // stylesheet understands, and throwing away what the user typed is worse.
  "tabs.colorUnparsed": "Kept exactly as typed — this control cannot read it, so the sliders and the readouts below are off.",
  "tabs.colorContrast": "Contrast {ratio}:1 against {against} — {grade}",
  ...
  "appearance.elTabGroup": "Tab group headers",
