...
export const M3_EN = {
  ...
  "converter.sourceHint": "Type the full path to a file already on this machine. No page in this app has a native file-browse dialog yet — that gap is not specific to this screen.",
