...
export const ja: Record<TKey, string> = {
  ...
  "path.browseFile": "参照…",
  "path.browseFolder": "フォルダーを参照…",
  "path.browsing": "開いています…",
  "path.browseFailed": "ファイル選択を開けませんでした。",
  ...
  "dash.mem.goHeap": "Go ヒープ（使用 / 合計）",
  "dash.mem.goroutines": "ゴルーチン",
  "dash.mem.hintGo": "読み取り専用のランタイム診断。Go ランタイムは単一のヒープから確保するため、ヒープが横ばいのまま常駐メモリだけ増える場合は、保持されたバッファか、まだ OS に返していないページを示します。",
  ...
  "dash.noModels": "モデルが見つかりません。プロバイダーを開いてプロバイダーを設定または有効化し、モデルを再読み込みしてください。",
  "dash.startProxy": "プロキシを起動",
  "dash.proxyStarting": "起動中…",
  "dash.proxyStarted": "プロキシを起動しました",
  "dash.proxyStartedBody": ":{port} で待機中です。",
  "dash.proxyAdopted": "すでに :{port} で稼働中でした — 再接続しました。",
  "dash.proxyStartFailed": "プロキシを起動できませんでした",
  ...
  "pws.auth.noKey": "キー不要",
  "pws.auth.vertexExternal": "Vertex 認証（ADC または任意の API キー）",
  ...
  "sidebar.starUnauthenticated": "GitHub を開いてスターを付ける(gh CLI が未サインイン)",
  "sidebar.starFailed": "gh 経由でスターを付けられませんでした。代わりに GitHub を開きます。",
  "sidebar.updateAvailable": "アップデートあり: {version}",
  "sidebar.checkUpdate": "アップデートを確認",
  "startup.backToDashboard": "ダッシュボードに戻る",
  "startup.repair": "修復",
  "startup.repairing": "修復中…",
  "startup.serviceRepaired": "バックグラウンドサービスを修復しました。",
  "startup.shimRepaired": "Codex ランチャーシムを修復しました。",
  "dash.mem.jsHeapArena": "アリーナ {total}",
  "dash.mem.pressure": "警告しきい値との比較",
  "dash.mem.pressureOf": "しきい値の {pct}%",
  "dash.mem.pressureUnknown": "しきい値が報告されていません",
  "dash.injectionManage": "設定を開く",
  "dash.syncModelsHint": "接続済みのプロバイダーをもとに Codex のモデルカタログを書き直します。",
  "dash.syncRun": "今すぐ同期",
  "sub.settings": "設定",
  "sub.sections": "サブエージェントのセクション",
  "sub.delegation.model": "最初に呼び出すモデル",
  "sub.delegation.modelHint": "Codex が作業を委任する際に最初に呼び出すモデルです。上の注目リストが呼び出せる候補だとすれば、これはそのうちの第一候補です。",
  "logs.badge.grok": "Grok",
  "logs.tokens.contextTotal": "アクティブなコンテキスト",
  "debug.loadFailed": "デバッグ設定を読み込めませんでした。",
  "storage.rescanned": "スキャンが完了しました。",
  "storage.snapshot.lastScan": "前回のスキャン",
  "storage.snapshot.scanning": "スキャン中…",
  "storage.snapshot.unavailable": "まだスキャンがありません。",
  "storage.cleanup.noArchives": "整理対象のアーカイブ済みセッションはありません。",
  ...
  "storage.policy.reduceInc": "縮小後サイズを上げる",
  "storage.policy.reduceDec": "縮小後サイズを下げる",
  "pws.dashboard.noRateLimits": "レート制限データはまだありません",
  "codexAuth.autoSwitchThresholdInc": "切り替えしきい値を上げる",
  "codexAuth.autoSwitchThresholdDec": "切り替えしきい値を下げる",
