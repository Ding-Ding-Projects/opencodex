...
export const ja: Record<TKey, string> = {
  ...
  "api.authChatCompletions": "ループバックでは Chat Completions と /v1/models が Authorization: Bearer ocx_...、x-api-key、または x-opencodex-api-key を受け付けます。ループバック以外の Chat リクエストには x-opencodex-api-key が必要です。",
  ...
  "api.copyUnavailable": "クリップボードを利用できません",
  "api.colPurpose": "用途",
  "api.genericKeyPurpose": "一般 API アクセス",
  "api.copilotKeyPurpose": "GitHub Copilot Desktop",
  "api.copilotEyebrow": "OpenAI 互換クライアントプロファイル",
  "api.copilotTitle": "GitHub Copilot Desktop",
  "api.copilotSubtitle": "GitHub Copilot Desktop を、OpenCodex が Chat Completions 経由で安全にルーティングできるすべてのモデルへ接続します。",
  "api.copilotVerifiedClient": "確認済みセットアップ契約: GitHub Copilot 1.1.4 Custom endpoint。",
  "api.copilotInboundDistinction": "これは受信クライアントプロファイルです。GitHub Copilot Desktop が OpenCodex を呼び出します。実験的で非公式な送信側 GitHub Copilot サブスクリプションプロバイダーとは別物です。",
  "api.copilotCopyBaseUrl": "GitHub Copilot Desktop のベース URL をコピー",
  "api.copilotCopyModelsEndpoint": "GitHub Copilot Desktop のモデルエンドポイントをコピー",
  "api.copilotCopyChatEndpoint": "GitHub Copilot Desktop の Chat Completions エンドポイントをコピー",
  "api.copilotBaseUrl": "ベース URL（/v1 を含む）",
  "api.copilotWireApi": "Wire API",
  "api.copilotModelsEndpoint": "モデル同期",
  "api.copilotChatEndpoint": "チャット",
  "api.copilotOptionalKey": "ループバックでは GitHub Copilot Desktop の API キー欄を空にできます。ローカルクライアント間の分離を強化するには専用の統合キーを生成してください。OpenCodex はこのキーを上流へ転送しません。",
  "api.copilotCustomHeaders": "専用キーを Custom headers で使う場合は、x-opencodex-api-key に生成された値を設定してください。ベース URL にキーを入れないでください。",
  "api.copilotGenerateKey": "統合キーを生成",
  "api.copilotManageKey": "キーを管理または取り消す",
  "api.copilotKeyName": "GitHub Copilot Desktop",
  "api.copilotRevealAbove": "新しいキーはこのカードの下にある一度だけ表示されるパネルに出ます。",
  "api.copilotStatusReady": "セットアップ可能",
  "api.copilotStatusWaiting": "最初のリクエストを待機中",
  "api.copilotStatusObserved": "最終リクエスト: HTTP {status} · {time}",
  "api.copilotStatusUnavailable": "準備状態を取得できません",
  "api.copilotReadyModels": "準備済みモデル {count} 件",
  "api.copilotProviderCount": "確認済みプロバイダー {count} 件",
  "api.copilotDirectTitle": "OpenAI Direct は対象外",
  "api.copilotDirectWarning": "管理対象の OpenAI Pool モードを使用してください。クライアントの bearer はローカル認証専用で、上流 OpenAI の資格情報として再利用されません。",
  "api.copilotSidecars": "Vision とウェブ検索 sidecar は設定済みで必要な場合のみ実行されます。Cursor のネイティブローカル実行はこのプロファイルでは利用できません。",
  "api.colReadiness": "Copilot 準備状態",
  "api.colCapabilities": "Copilot 機能",
  "api.capabilityReady": "準備完了",
  "api.capabilityUnavailable": "利用不可",
  "api.capabilityChat": "チャット",
  "api.capabilityAgent": "Agent ツール",
  "api.capabilityImages": "画像",
  "api.capabilityReasoning": "推論",
  "api.capabilityStructured": "構造化出力",
  "api.capabilitySidecar": "Sidecar が実行される場合あり",
  "api.capabilityYes": "はい",
  "api.capabilityNo": "いいえ",
  "api.testUnavailable": "このモデルは GitHub Copilot Desktop プロファイルでは利用できません。準備状態の理由を確認してください。",
  "api.reason.ready": "準備完了",
  "api.reason.provider-disabled": "プロバイダーが無効",
  "api.reason.missing-credential": "ログインまたは API キーが必要",
  "api.reason.needs-reauthentication": "再認証が必要",
  "api.reason.direct-mode-unsupported": "OpenAI Direct は非対応です。Pool を使用してください",
  "api.reason.cursor-native-execution-unavailable": "Cursor のネイティブローカル実行を無効にしてください",
  "api.reason.unresolved-route": "ルートを解決できません",
  "api.reason.unsupported-adapter": "アダプターは非対応です",
  "api.regexBuilder": "正規表現",
  "api.regexBuilderTitle": "モデル検索の正規表現ビルダー",
  "api.regexClose": "閉じる",
  "api.regexEnable": "この検索で正規表現を使用",
  "api.regexPattern": "パターン",
  "api.regexGuided": "ガイド付きパターン操作",
  "api.regexLiteral": "リテラル",
  "api.regexAnchors": "アンカー",
  "api.regexGroup": "グループ",
  "api.regexAlternate": "選択",
  "api.regexQuantifier": "1 回以上",
  "api.regexClass": "文字クラス",
  "api.regexFlags": "フラグ",
  "api.regexSample": "サンプルテキスト",
  "api.regexMatches": "一致 {count} 件",
  "api.regexZeroWidth": "ゼロ幅一致",
  "api.regexCopy": "パターンをコピー",
  "api.regexEngine": "エンジン: JavaScript RegExp。評価はローカルで行い、パターン 512 文字、サンプル 4,096 文字に制限します。",
  "api.regexTooLong": "パターンは 512 文字以内にしてください。",
  "api.regexInvalid": "パターンが無効です。",
  // Claude Code inbound
  "nav.claude": "Claude",
  ...
  "claude.fastOn": "オン",
  "claude.fastOff": "オフ",
  "claude.maxContext": "コンテキストサイズの上書き",
  "claude.maxContextDesc": "新しい Claude Code セッション用の範囲が限定されたプリセットを選びます。自動はクライアントとモデルの既定値を使い、1000000 は 1M を要求します。保存済みのカスタム値は置き換えるまで選択肢に残ります。",
  "claude.maxContextWarn": "この上書きは自動圧縮を無効にします。長いチャットはモデルの実際のコンテキスト上限に達してエラーになることがあります。",
  "claude.maxContextAutomatic": "自動（クライアントとモデルの既定値）",
  "claude.maxContextDefaultProvenance": "組み込みの自動設定を使用中です。設定ファイルにコンテキストサイズの上書きは保存されていません。",
  "claude.maxContextFileProvenance": "次の Claude Code セッション用に opencodex 設定ファイルへ保存されています。自分でエクスポートした環境変数がある場合は、そちらが引き続き優先されます。",
  "claude.maxContextDraftProvenance": "未保存の選択です。設定ファイルでは引き続き {value} を使用しています。この変更を適用するには保存を選んでください。",
  "claude.maxContextAutomaticValue": "自動",
  "claude.maxContextInvalidStoredProvenance": "設定ファイルに無効なコンテキストサイズの上書きがあります。自動を表示しています。保存を選ぶと無効な値を削除します。",
  "claude.maxContextInvalidStoredValue": "無効な保存値",
  ...
  "claude.autoContextInert": "「コンテキストサイズの上書き」が設定されている間は無効です。再び有効にするには、上で「自動」を選んでください。",
