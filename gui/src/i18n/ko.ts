...
export const ko: Record<TKey, string> = {
  ...
  "path.browseFile": "찾아보기…",
  "path.browseFolder": "폴더 찾아보기…",
  "path.browsing": "여는 중…",
  "path.browseFailed": "파일 선택기를 열 수 없습니다.",
  ...
  "dash.mem.goHeap": "Go 힙 (사용 / 전체)",
  "dash.mem.goroutines": "고루틴",
  "dash.mem.hintGo": "읽기 전용 런타임 진단. Go 런타임은 힙 하나에서 할당하므로, 힙은 그대로인데 상주 메모리만 늘면 붙잡고 있는 버퍼이거나 아직 OS에 돌려주지 않은 페이지입니다.",
