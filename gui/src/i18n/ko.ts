...
export const ko: Record<TKey, string> = {
  ...
  "dash.noModels": "모델을 찾을 수 없습니다. 프로바이더에서 프로바이더를 구성하거나 활성화한 다음 모델을 새로 고치세요.",
  "dash.startProxy": "프록시 시작",
  "dash.proxyStarting": "시작하는 중…",
  "dash.proxyStarted": "프록시를 시작했습니다",
  "dash.proxyStartedBody": ":{port} 에서 대기 중입니다.",
  "dash.proxyAdopted": "이미 :{port} 에서 실행 중이었습니다 — 다시 연결했습니다.",
  "dash.proxyStartFailed": "프록시를 시작할 수 없습니다",
  ...
  "api.authChatCompletions": "루프백에서는 Chat Completions와 /v1/models가 Authorization: Bearer ocx_..., x-api-key 또는 x-opencodex-api-key를 허용합니다. 비루프백 Chat 요청에는 x-opencodex-api-key가 필요합니다.",
  ...
  "api.copyUnavailable": "클립보드를 사용할 수 없음",
  "api.colPurpose": "용도",
  "api.genericKeyPurpose": "일반 API 액세스",
  "api.copilotKeyPurpose": "GitHub Copilot Desktop",
  "api.copilotEyebrow": "OpenAI 호환 클라이언트 프로필",
  "api.copilotTitle": "GitHub Copilot Desktop",
  "api.copilotSubtitle": "GitHub Copilot Desktop을 OpenCodex가 Chat Completions로 안전하게 라우팅할 수 있는 모든 모델에 연결합니다.",
  "api.copilotVerifiedClient": "검증된 설정 계약: GitHub Copilot 1.1.4 Custom endpoint.",
  "api.copilotInboundDistinction": "이 기능은 인바운드 클라이언트 프로필입니다. GitHub Copilot Desktop이 OpenCodex를 호출합니다. 실험적이고 비공식적인 아웃바운드 GitHub Copilot 구독 제공자와는 별개입니다.",
  "api.copilotCopyBaseUrl": "GitHub Copilot Desktop 기본 URL 복사",
  "api.copilotCopyModelsEndpoint": "GitHub Copilot Desktop 모델 엔드포인트 복사",
  "api.copilotCopyChatEndpoint": "GitHub Copilot Desktop Chat Completions 엔드포인트 복사",
  "api.copilotBaseUrl": "기본 URL (/v1 포함)",
  "api.copilotWireApi": "Wire API",
  "api.copilotModelsEndpoint": "모델 동기화",
  "api.copilotChatEndpoint": "채팅",
  "api.copilotOptionalKey": "루프백에서는 GitHub Copilot Desktop의 API 키 필드를 비워 둘 수 있습니다. 로컬 클라이언트 간 격리를 강화하려면 전용 통합 키를 생성하세요. OpenCodex는 이 키를 업스트림으로 전달하지 않습니다.",
  "api.copilotCustomHeaders": "전용 키를 Custom headers로 사용하려면 x-opencodex-api-key에 생성된 값을 설정하세요. 기본 URL에는 키를 넣지 마세요.",
  "api.copilotGenerateKey": "통합 키 생성",
  "api.copilotManageKey": "키 관리 또는 폐기",
  "api.copilotKeyName": "GitHub Copilot Desktop",
  "api.copilotRevealAbove": "새 키는 이 카드 아래의 일회성 표시 패널에 나타납니다.",
  "api.copilotStatusReady": "설정 준비됨",
  "api.copilotStatusWaiting": "첫 요청 대기 중",
  "api.copilotStatusObserved": "마지막 요청: HTTP {status} · {time}",
  "api.copilotStatusUnavailable": "준비 상태를 확인할 수 없음",
  "api.copilotReadyModels": "준비된 모델 {count}개",
  "api.copilotProviderCount": "확인한 제공자 {count}개",
  "api.copilotDirectTitle": "OpenAI Direct 제외",
  "api.copilotDirectWarning": "관리형 OpenAI Pool 모드를 사용하세요. 클라이언트 bearer 슬롯은 로컬 입장 인증용이며 업스트림 OpenAI 자격 증명으로 재사용되지 않습니다.",
  "api.copilotSidecars": "Vision 및 웹 검색 sidecar는 설정되어 있고 필요할 때만 실행될 수 있습니다. Cursor 네이티브 로컬 실행은 이 프로필에서 사용할 수 없습니다.",
  "api.colReadiness": "Copilot 준비 상태",
  "api.colCapabilities": "Copilot 기능",
  "api.capabilityReady": "준비됨",
  "api.capabilityUnavailable": "사용 불가",
  "api.capabilityChat": "채팅",
  "api.capabilityAgent": "Agent 도구",
  "api.capabilityImages": "이미지",
  "api.capabilityReasoning": "추론",
  "api.capabilityStructured": "구조화 출력",
  "api.capabilitySidecar": "Sidecar 실행 가능",
  "api.capabilityYes": "예",
  "api.capabilityNo": "아니요",
  "api.testUnavailable": "이 모델은 GitHub Copilot Desktop 프로필에서 사용할 수 없습니다. 준비 상태 사유를 확인하세요.",
  "api.reason.ready": "준비됨",
  "api.reason.provider-disabled": "제공자 비활성화됨",
  "api.reason.missing-credential": "로그인 또는 API 키 필요",
  "api.reason.needs-reauthentication": "재인증 필요",
  "api.reason.direct-mode-unsupported": "OpenAI Direct 미지원, Pool 사용",
  "api.reason.cursor-native-execution-unavailable": "Cursor 네이티브 로컬 실행을 꺼야 함",
  "api.reason.unresolved-route": "라우트를 확인할 수 없음",
  "api.reason.unsupported-adapter": "지원되지 않는 어댑터",
  "api.regexBuilder": "정규식",
  "api.regexBuilderTitle": "모델 검색 정규식 빌더",
  "api.regexClose": "닫기",
  "api.regexEnable": "이 검색에 정규식 사용",
  "api.regexPattern": "패턴",
  "api.regexGuided": "안내식 패턴 컨트롤",
  "api.regexLiteral": "리터럴",
  "api.regexAnchors": "앵커",
  "api.regexGroup": "그룹",
  "api.regexAlternate": "대안",
  "api.regexQuantifier": "하나 이상",
  "api.regexClass": "문자 클래스",
  "api.regexFlags": "플래그",
  "api.regexSample": "샘플 텍스트",
  "api.regexMatches": "일치 {count}개",
  "api.regexZeroWidth": "폭이 0인 일치",
  "api.regexCopy": "패턴 복사",
  "api.regexEngine": "엔진: JavaScript RegExp. 평가는 로컬에서 수행되며 패턴 512자와 샘플 4,096자로 제한됩니다.",
  "api.regexTooLong": "패턴은 512자 이하여야 합니다.",
  "api.regexInvalid": "패턴이 올바르지 않습니다.",
  // Claude Code inbound
  "nav.claude": "Claude",
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "컨텍스트 크기 재정의",
  "claude.maxContextDesc": "새 Claude Code 세션에 사용할 제한된 프리셋을 고릅니다. 자동은 클라이언트와 모델 기본값을 사용하고, 1000000은 1M을 요청합니다. 저장된 사용자 지정 값은 다른 값으로 바꿀 때까지 선택지에 남습니다.",
  "claude.maxContextWarn": "이 재정의는 자동 압축을 끕니다. 긴 대화는 모델의 실제 컨텍스트 한도에 도달해 오류가 날 수 있습니다.",
  "claude.maxContextAutomatic": "자동 (클라이언트 및 모델 기본값)",
  "claude.maxContextDefaultProvenance": "내장된 자동 기본값을 사용 중이며 설정 파일에는 컨텍스트 크기 재정의가 저장되지 않았습니다.",
  "claude.maxContextFileProvenance": "다음 Claude Code 세션을 위해 opencodex 설정 파일에 저장되었습니다. 사용자가 직접 내보낸 환경 변수가 있으면 그 값이 계속 우선합니다.",
  "claude.maxContextDraftProvenance": "저장되지 않은 선택입니다. 설정 파일은 아직 {value}을(를) 사용합니다. 이 변경을 적용하려면 저장을 선택하세요.",
  "claude.maxContextAutomaticValue": "자동",
  "claude.maxContextInvalidStoredProvenance": "설정 파일에 잘못된 컨텍스트 크기 재정의가 있습니다. 자동을 표시하며, 저장을 선택하면 잘못된 값을 제거합니다.",
  "claude.maxContextInvalidStoredValue": "잘못 저장된 값",
  ...
  "claude.autoContextInert": "컨텍스트 크기 재정의가 설정된 동안에는 비활성입니다. 다시 활성화하려면 위에서 자동을 선택하세요.",
  ...
  "pws.auth.vertexExternal": "Vertex 인증(ADC 또는 선택적 API 키)",
