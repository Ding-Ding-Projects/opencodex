...
export const zh: Record<TKey, string> = {
  ...
  "path.browseFile": "浏览…",
  "path.browseFolder": "浏览文件夹…",
  "path.browsing": "正在打开…",
  "path.browseFailed": "无法打开文件选择器。",
  ...
  "dash.mem.goHeap": "Go 堆（已用 / 总计）",
  "dash.mem.goroutines": "Goroutine",
  "dash.mem.hintGo": "只读运行时诊断。Go 运行时从单一堆分配，因此堆保持平稳而常驻内存上升，说明是被保留的缓冲区或尚未归还给操作系统的页。",
