...
export const zh: Record<TKey, string> = {
  ...
  "dash.noModels": "未找到模型。请打开“提供方”，配置或启用一个提供方，然后刷新模型。",
  "dash.startProxy": "启动代理",
  "dash.proxyStarting": "正在启动…",
  "dash.proxyStarted": "代理已启动",
  "dash.proxyStartedBody": "正在监听 :{port}。",
  "dash.proxyAdopted": "代理原本就在 :{port} 运行 — 已重新连接。",
  "dash.proxyStartFailed": "无法启动代理",
  ...
  "api.authChatCompletions": "在回环地址上，Chat Completions 和 /v1/models 接受 Authorization: Bearer ocx_...、x-api-key 或 x-opencodex-api-key。非回环 Chat 请求必须使用 x-opencodex-api-key。",
  ...
  "api.copyUnavailable": "剪贴板不可用",
  "api.colPurpose": "用途",
  "api.genericKeyPurpose": "通用 API 访问",
  "api.copilotKeyPurpose": "GitHub Copilot Desktop",
  "api.copilotEyebrow": "OpenAI 兼容客户端配置",
  "api.copilotTitle": "GitHub Copilot Desktop",
  "api.copilotSubtitle": "将 GitHub Copilot Desktop 连接到 OpenCodex 能通过 Chat Completions 安全路由的所有模型。",
  "api.copilotVerifiedClient": "已验证的设置契约：GitHub Copilot 1.1.4 Custom endpoint。",
  "api.copilotInboundDistinction": "这是入站客户端配置：GitHub Copilot Desktop 调用 OpenCodex。它与实验性、非官方的出站 GitHub Copilot 订阅提供商彼此独立。",
  "api.copilotCopyBaseUrl": "复制 GitHub Copilot Desktop 基础 URL",
  "api.copilotCopyModelsEndpoint": "复制 GitHub Copilot Desktop 模型端点",
  "api.copilotCopyChatEndpoint": "复制 GitHub Copilot Desktop Chat Completions 端点",
  "api.copilotBaseUrl": "基础 URL（包含 /v1）",
  "api.copilotWireApi": "Wire API",
  "api.copilotModelsEndpoint": "模型同步",
  "api.copilotChatEndpoint": "聊天",
  "api.copilotOptionalKey": "在回环地址上，GitHub Copilot Desktop 的 API 密钥字段可以留空。生成专用集成密钥可加强本地客户端隔离；OpenCodex 绝不会将其转发给上游。",
  "api.copilotCustomHeaders": "若通过 Custom headers 使用专用密钥，请将 x-opencodex-api-key 设为生成的值。切勿把密钥放进基础 URL。",
  "api.copilotGenerateKey": "生成集成密钥",
  "api.copilotManageKey": "管理或撤销密钥",
  "api.copilotKeyName": "GitHub Copilot Desktop",
  "api.copilotRevealAbove": "新密钥只会在此卡片下方的一次性显示面板中出现。",
  "api.copilotStatusReady": "可以开始设置",
  "api.copilotStatusWaiting": "等待首次请求",
  "api.copilotStatusObserved": "最近请求：HTTP {status} · {time}",
  "api.copilotStatusUnavailable": "无法获取就绪状态",
  "api.copilotReadyModels": "{count} 个模型已就绪",
  "api.copilotProviderCount": "已检查 {count} 个提供商",
  "api.copilotDirectTitle": "不支持 OpenAI Direct",
  "api.copilotDirectWarning": "请使用托管的 OpenAI Pool 模式。客户端 bearer 槽位仅用于本地准入，绝不会作为上游 OpenAI 凭据重复使用。",
  "api.copilotSidecars": "Vision 和网络搜索 sidecar 仅在已配置且需要时运行。此配置不允许 Cursor 原生本地执行。",
  "api.colReadiness": "Copilot 就绪状态",
  "api.colCapabilities": "Copilot 能力",
  "api.capabilityReady": "已就绪",
  "api.capabilityUnavailable": "不可用",
  "api.capabilityChat": "聊天",
  "api.capabilityAgent": "Agent 工具",
  "api.capabilityImages": "图片",
  "api.capabilityReasoning": "推理",
  "api.capabilityStructured": "结构化输出",
  "api.capabilitySidecar": "可能运行 Sidecar",
  "api.capabilityYes": "是",
  "api.capabilityNo": "否",
  "api.testUnavailable": "此模型不适用于 GitHub Copilot Desktop 配置。请查看就绪原因。",
  "api.reason.ready": "已就绪",
  "api.reason.provider-disabled": "提供商已禁用",
  "api.reason.missing-credential": "需要登录或 API 密钥",
  "api.reason.needs-reauthentication": "需要重新认证",
  "api.reason.direct-mode-unsupported": "不支持 OpenAI Direct，请使用 Pool",
  "api.reason.cursor-native-execution-unavailable": "必须禁用 Cursor 原生本地执行",
  "api.reason.unresolved-route": "无法解析路由",
  "api.reason.unsupported-adapter": "不支持此适配器",
  "api.regexBuilder": "正则表达式",
  "api.regexBuilderTitle": "模型搜索正则构建器",
  "api.regexClose": "关闭",
  "api.regexEnable": "为此搜索使用正则表达式",
  "api.regexPattern": "模式",
  "api.regexGuided": "引导式模式控件",
  "api.regexLiteral": "字面量",
  "api.regexAnchors": "锚点",
  "api.regexGroup": "分组",
  "api.regexAlternate": "分支",
  "api.regexQuantifier": "一个或多个",
  "api.regexClass": "字符类",
  "api.regexFlags": "标志",
  "api.regexSample": "示例文本",
  "api.regexMatches": "{count} 个匹配",
  "api.regexZeroWidth": "零宽匹配",
  "api.regexCopy": "复制模式",
  "api.regexEngine": "引擎：JavaScript RegExp。计算仅在本地进行，模式最多 512 个字符，示例最多 4,096 个字符。",
  "api.regexTooLong": "模式不能超过 512 个字符。",
  "api.regexInvalid": "模式无效。",
  // Claude Code inbound
  "nav.claude": "Claude",
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "上下文大小覆盖",
  "claude.maxContextDesc": "为新的 Claude Code 会话选择有界预设。自动会使用客户端和模型默认值；1000000 会请求 1M。已保存的自定义值会一直保留在选项中，直到您替换它。",
  "claude.maxContextWarn": "此覆盖会关闭自动压缩。长对话可能达到模型的实际上下文上限并报错。",
  "claude.maxContextAutomatic": "自动（客户端和模型默认值）",
  "claude.maxContextDefaultProvenance": "当前使用内置的自动默认值；配置文件中没有保存上下文大小覆盖。",
  "claude.maxContextFileProvenance": "已保存到 opencodex 配置文件，供下一个 Claude Code 会话使用。您自行导出的环境变量仍然优先。",
  "claude.maxContextDraftProvenance": "此选择尚未保存。配置文件仍使用 {value}；请选择“保存”以应用此更改。",
  "claude.maxContextAutomaticValue": "自动",
  "claude.maxContextInvalidStoredProvenance": "配置文件中包含无效的上下文大小覆盖。当前显示为自动；请选择“保存”以移除无效值。",
  "claude.maxContextInvalidStoredValue": "无效的已存储值",
  "claude.autoContext": "自动利用大上下文",
  "claude.autoContextDesc": "决定 1M 标记的范围。开：所有超过 20 万 token 的模型（GPT 系列等）都有大上下文条目；关：仅真正的 1M 模型有。",
  "claude.autoContextInert": "设置上下文大小覆盖时，此功能不生效。请在上方选择“自动”以重新启用。",
  ...
  "pws.auth.noKey": "无需密钥",
  "pws.auth.vertexExternal": "Vertex 身份验证（ADC 或可选 API 密钥）",
