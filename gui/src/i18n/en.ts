...
export const en = {
  ...
  "dash.noModels": "No models found. Open Providers to configure or enable a provider, then refresh models.",
  "dash.startProxy": "Start the proxy",
  "dash.proxyStarting": "Starting…",
  "dash.proxyStarted": "Proxy started",
  "dash.proxyStartedBody": "Listening on :{port}.",
  "dash.proxyAdopted": "Already running on :{port} — reconnected.",
  ...
  "pws.auth.vertexExternal": "Vertex auth (ADC or optional API key)",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "api.authChatCompletions": "On loopback, Chat Completions and /v1/models accept Authorization: Bearer ocx_..., x-api-key, or x-opencodex-api-key. Non-loopback Chat requests require x-opencodex-api-key.",
  ...
  "api.copyUnavailable": "Clipboard unavailable",
  "api.colPurpose": "Purpose",
  "api.genericKeyPurpose": "General API access",
  "api.copilotKeyPurpose": "GitHub Copilot Desktop",
  "api.copilotEyebrow": "OpenAI-compatible client profile",
  "api.copilotTitle": "GitHub Copilot Desktop",
  "api.copilotSubtitle": "Connect GitHub Copilot Desktop to every model OpenCodex can safely route through Chat Completions.",
  "api.copilotVerifiedClient": "Verified setup contract: GitHub Copilot 1.1.4 Custom endpoint.",
  "api.copilotInboundDistinction": "This is an inbound client profile: GitHub Copilot Desktop calls OpenCodex. It is separate from the experimental, unofficial outbound GitHub Copilot subscription provider.",
  "api.copilotCopyBaseUrl": "Copy GitHub Copilot Desktop base URL",
  "api.copilotCopyModelsEndpoint": "Copy GitHub Copilot Desktop models endpoint",
  "api.copilotCopyChatEndpoint": "Copy GitHub Copilot Desktop Chat Completions endpoint",
  "api.copilotBaseUrl": "Base URL (include /v1)",
  "api.copilotWireApi": "Wire API",
  "api.copilotModelsEndpoint": "Model sync",
  "api.copilotChatEndpoint": "Chat",
  "api.copilotOptionalKey": "GitHub Copilot Desktop allows its API key field to be blank on loopback. Generate a dedicated integration key for stronger isolation between local clients; OpenCodex never forwards it upstream.",
  "api.copilotCustomHeaders": "If you use the dedicated key through Custom headers, set x-opencodex-api-key to the generated value. Never put a key in the Base URL.",
  "api.copilotGenerateKey": "Generate integration key",
  "api.copilotManageKey": "Manage or revoke key",
  "api.copilotKeyName": "GitHub Copilot Desktop",
  "api.copilotRevealAbove": "The new key is shown once in the reveal panel below this card.",
  "api.copilotStatusReady": "Ready for setup",
  "api.copilotStatusWaiting": "Waiting for first request",
  "api.copilotStatusObserved": "Last request: HTTP {status} · {time}",
  "api.copilotStatusUnavailable": "Readiness unavailable",
  "api.copilotReadyModels": "{count} models ready",
  "api.copilotProviderCount": "{count} providers checked",
  "api.copilotDirectTitle": "OpenAI Direct is excluded",
  "api.copilotDirectWarning": "Use the managed OpenAI Pool mode. The client bearer slot belongs to local admission and is never reused as an upstream OpenAI credential.",
  "api.copilotSidecars": "Vision and web-search sidecars may run only when configured and needed. Cursor native local execution is unavailable to this profile.",
  "api.colReadiness": "Copilot readiness",
  "api.colCapabilities": "Copilot capabilities",
  "api.capabilityReady": "Ready",
  "api.capabilityUnavailable": "Unavailable",
  "api.capabilityChat": "Chat",
  "api.capabilityAgent": "Agent tools",
  "api.capabilityImages": "Images",
  "api.capabilityReasoning": "Reasoning",
  "api.capabilityStructured": "Structured output",
  "api.capabilitySidecar": "Sidecar may run",
  "api.capabilityYes": "Yes",
  "api.capabilityNo": "No",
  "api.testUnavailable": "This model is unavailable to the GitHub Copilot Desktop profile. See its readiness reason.",
  "api.reason.ready": "Ready",
  "api.reason.provider-disabled": "Provider disabled",
  "api.reason.missing-credential": "Login or API key required",
  "api.reason.needs-reauthentication": "Reauthentication required",
  "api.reason.direct-mode-unsupported": "OpenAI Direct is unsupported; use Pool",
  "api.reason.cursor-native-execution-unavailable": "Cursor native local execution must be disabled",
  "api.reason.unresolved-route": "Route could not be resolved",
  "api.reason.unsupported-adapter": "Adapter is unsupported",
  "api.regexBuilder": "Regex",
  "api.regexBuilderTitle": "Model-search regex builder",
  "api.regexClose": "Close",
  "api.regexEnable": "Use regex for this search",
  "api.regexPattern": "Pattern",
  "api.regexGuided": "Guided pattern controls",
  "api.regexLiteral": "Literal",
  "api.regexAnchors": "Anchors",
  "api.regexGroup": "Group",
  "api.regexAlternate": "Alternation",
  "api.regexQuantifier": "One or more",
  "api.regexClass": "Character class",
  "api.regexFlags": "Flags",
  "api.regexSample": "Sample text",
  "api.regexMatches": "{count} matches",
  "api.regexZeroWidth": "zero-width match",
  "api.regexCopy": "Copy pattern",
  "api.regexEngine": "Engine: JavaScript RegExp. Evaluation is local and bounded to 512 pattern characters and 4,096 sample characters.",
  "api.regexTooLong": "Pattern must be 512 characters or fewer.",
  "api.regexInvalid": "Pattern is invalid.",
  // Claude Code inbound
  "nav.claude": "Claude",
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "Context size override",
  "claude.maxContextDesc": "Choose a bounded preset for new Claude Code sessions. Automatic uses Claude's client and model default; 1000000 requests 1M. A saved custom value stays available until you replace it.",
  "claude.maxContextWarn": "This override disables automatic compaction. A long chat can reach the model's actual context limit and error.",
  "claude.maxContextAutomatic": "Automatic (client and model default)",
  "claude.maxContextDefaultProvenance": "Using the compiled-in Automatic default; no context-size override is stored in the config file.",
  "claude.maxContextFileProvenance": "Saved in the opencodex config file for the next Claude Code session. An environment variable you exported yourself still takes precedence.",
  "claude.maxContextDraftProvenance": "Unsaved selection. The config file still uses {value}; choose Save to apply this change.",
  "claude.maxContextAutomaticValue": "Automatic",
  "claude.maxContextInvalidStoredProvenance": "The config file contains an invalid context-size override. Automatic is shown; choose Save to remove the invalid value.",
  "claude.maxContextInvalidStoredValue": "an invalid stored value",
  ...
  "claude.autoContextInert": "Inactive while Context size override is set. Choose Automatic above to re-enable it.",
