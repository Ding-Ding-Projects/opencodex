...
export const en = {
  ...
  "dash.mem.hintGo": "Read-only runtime diagnostics. The Go runtime allocates from one heap, so resident memory rising while the heap stays flat points at retained buffers or pages not yet returned to the OS.",
