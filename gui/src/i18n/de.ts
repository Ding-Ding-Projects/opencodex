...
export const de: Record<TKey, string> = {
  ...
  "path.browseFile": "Durchsuchen…",
  "path.browseFolder": "Ordner wählen…",
  "path.browsing": "Wird geöffnet…",
  "path.browseFailed": "Dateiauswahl konnte nicht geöffnet werden.",
  ...
  "dash.mem.goHeap": "Go-Heap (belegt / gesamt)",
  "dash.mem.goroutines": "Goroutinen",
  "dash.mem.hintGo": "Schreibgeschützte Laufzeitdiagnose. Die Go-Laufzeit belegt Speicher aus einem einzigen Heap; steigt der residente Speicher bei gleichbleibendem Heap, deutet das auf gehaltene Puffer oder noch nicht an das Betriebssystem zurückgegebene Seiten hin.",
  ...
  "dash.updateStatus.cancelled": "Update abgebrochen.",
  "dash.updateManualRestart": "Starte den Proxy manuell neu, um die neue Version zu verwenden.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "api.copyThisKeyNow": "Copy this key now",
  ...
  "startup.serviceRepaired": "Hintergrunddienst erfolgreich repariert.",
  "startup.shimRepaired": "Codex-Launcher-Shim erfolgreich repariert.",
  "dash.mem.jsHeapArena": "Arena {total}",
  "dash.mem.pressure": "Gegenüber Warnschwelle",
  "dash.mem.pressureOf": "{pct}% des Schwellenwerts",
  "dash.mem.pressureUnknown": "Kein Schwellenwert gemeldet",
  ...
  "sub.sections": "Subagent-Bereiche",
  "sub.delegation.model": "Zuerst aufzurufendes Modell",
  "sub.delegation.modelHint": "Das Modell, das Codex zuerst aufruft, wenn Arbeit übergeben wird. Oben empfohlen sind die Kandidaten, die aufgerufen werden dürfen; dieses hier ist die erste Wahl.",
  "logs.badge.grok": "Grok",
  "logs.tokens.contextTotal": "aktiver Kontext",
  "debug.loadFailed": "Debug-Einstellungen konnten nicht geladen werden.",
  "storage.rescanned": "Scan abgeschlossen.",
  "storage.snapshot.lastScan": "Letzter Scan",
  "storage.snapshot.scanning": "Wird gescannt…",
  ...
  "storage.policy.thresholdInc": "Schwellenwert erhöhen",
  "storage.policy.thresholdDec": "Schwellenwert verringern",
  "storage.policy.percentInc": "Prozentsatz erhöhen",
  "storage.policy.percentDec": "Prozentsatz verringern",
  "storage.policy.reduceInc": "Zielgröße erhöhen",
  "storage.policy.reduceDec": "Zielgröße verringern",
  "pws.dashboard.noRateLimits": "Noch keine Ratenlimit-Daten",
  "codexAuth.autoSwitchThresholdInc": "Wechselschwelle erhöhen",
  "codexAuth.autoSwitchThresholdDec": "Wechselschwelle verringern",
  ...
  "api.copyUrlHint": "Klicken, um URL zu kopieren",
  "api.urlCopied": "URL kopiert",
  "api.copyExampleHint": "Klicken, um Beispiel zu kopieren",
