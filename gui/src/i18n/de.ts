...
export const de: Record<TKey, string> = {
  ...
  "dash.noModels": "Keine Modelle gefunden. Öffne „Anbieter“, konfiguriere oder aktiviere einen Anbieter und aktualisiere dann die Modelle.",
  "dash.startProxy": "Proxy starten",
  "dash.proxyStarting": "Wird gestartet…",
  "dash.proxyStarted": "Proxy gestartet",
  "dash.proxyStartedBody": "Läuft auf :{port}.",
  "dash.proxyAdopted": "Lief bereits auf :{port} — wieder verbunden.",
  "dash.proxyStartFailed": "Proxy konnte nicht gestartet werden",
  ...
  "api.authChatCompletions": "Auf Loopback akzeptieren Chat Completions und /v1/models Authorization: Bearer ocx_..., x-api-key oder x-opencodex-api-key. Nicht-lokale Chat-Anfragen benötigen x-opencodex-api-key.",
  ...
  "api.copyUnavailable": "Zwischenablage nicht verfügbar",
  "api.colPurpose": "Zweck",
  "api.genericKeyPurpose": "Allgemeiner API-Zugriff",
  "api.copilotKeyPurpose": "GitHub Copilot Desktop",
  "api.copilotEyebrow": "OpenAI-kompatibles Clientprofil",
  "api.copilotTitle": "GitHub Copilot Desktop",
  "api.copilotSubtitle": "Verbinde GitHub Copilot Desktop mit jedem Modell, das OpenCodex sicher über Chat Completions routen kann.",
  "api.copilotVerifiedClient": "Verifizierter Einrichtungsvertrag: GitHub Copilot 1.1.4 Custom endpoint.",
  "api.copilotInboundDistinction": "Dies ist ein eingehendes Clientprofil: GitHub Copilot Desktop ruft OpenCodex auf. Es ist vom experimentellen, inoffiziellen ausgehenden GitHub-Copilot-Abonnementanbieter getrennt.",
  "api.copilotCopyBaseUrl": "GitHub-Copilot-Desktop-Basis-URL kopieren",
  "api.copilotCopyModelsEndpoint": "GitHub-Copilot-Desktop-Modellendpunkt kopieren",
  "api.copilotCopyChatEndpoint": "GitHub-Copilot-Desktop-Chat-Completions-Endpunkt kopieren",
  "api.copilotBaseUrl": "Basis-URL (mit /v1)",
  "api.copilotWireApi": "Wire API",
  "api.copilotModelsEndpoint": "Modellsynchronisierung",
  "api.copilotChatEndpoint": "Chat",
  "api.copilotOptionalKey": "GitHub Copilot Desktop erlaubt auf Loopback ein leeres API-Schlüsselfeld. Ein eigener Integrationsschlüssel trennt lokale Clients besser; OpenCodex leitet ihn niemals an Anbieter weiter.",
  "api.copilotCustomHeaders": "Wenn du den eigenen Schlüssel über benutzerdefinierte Header verwendest, setze x-opencodex-api-key auf den generierten Wert. Lege niemals einen Schlüssel in die Basis-URL.",
  "api.copilotGenerateKey": "Integrationsschlüssel generieren",
  "api.copilotManageKey": "Schlüssel verwalten oder widerrufen",
  "api.copilotKeyName": "GitHub Copilot Desktop",
  "api.copilotRevealAbove": "Der neue Schlüssel wird einmalig im Bereich unter dieser Karte angezeigt.",
  "api.copilotStatusReady": "Bereit zur Einrichtung",
  "api.copilotStatusWaiting": "Warten auf die erste Anfrage",
  "api.copilotStatusObserved": "Letzte Anfrage: HTTP {status} · {time}",
  "api.copilotStatusUnavailable": "Bereitschaft nicht verfügbar",
  "api.copilotReadyModels": "{count} Modelle bereit",
  "api.copilotProviderCount": "{count} Anbieter geprüft",
  "api.copilotDirectTitle": "OpenAI Direct ist ausgeschlossen",
  "api.copilotDirectWarning": "Verwende den verwalteten OpenAI-Poolmodus. Der Client-Bearer ist für die lokale Zulassung reserviert und wird nie als OpenAI-Zugangsdaten weiterverwendet.",
  "api.copilotSidecars": "Vision- und Websuche-Sidecars laufen nur bei Bedarf und entsprechender Konfiguration. Native lokale Cursor-Ausführung ist für dieses Profil nicht verfügbar.",
  "api.colReadiness": "Copilot-Bereitschaft",
  "api.colCapabilities": "Copilot-Fähigkeiten",
  "api.capabilityReady": "Bereit",
  "api.capabilityUnavailable": "Nicht verfügbar",
  "api.capabilityChat": "Chat",
  "api.capabilityAgent": "Agent-Werkzeuge",
  "api.capabilityImages": "Bilder",
  "api.capabilityReasoning": "Reasoning",
  "api.capabilityStructured": "Strukturierte Ausgabe",
  "api.capabilitySidecar": "Sidecar kann laufen",
  "api.capabilityYes": "Ja",
  "api.capabilityNo": "Nein",
  "api.testUnavailable": "Dieses Modell ist für das GitHub-Copilot-Desktop-Profil nicht verfügbar. Siehe Bereitschaftsgrund.",
  "api.reason.ready": "Bereit",
  "api.reason.provider-disabled": "Anbieter deaktiviert",
  "api.reason.missing-credential": "Anmeldung oder API-Schlüssel erforderlich",
  "api.reason.needs-reauthentication": "Erneute Authentifizierung erforderlich",
  "api.reason.direct-mode-unsupported": "OpenAI Direct wird nicht unterstützt; Pool verwenden",
  "api.reason.cursor-native-execution-unavailable": "Native lokale Cursor-Ausführung muss deaktiviert sein",
  "api.reason.unresolved-route": "Route konnte nicht aufgelöst werden",
  "api.reason.unsupported-adapter": "Adapter wird nicht unterstützt",
  "api.regexBuilder": "Regex",
  "api.regexBuilderTitle": "Regex-Builder für die Modellsuche",
  "api.regexClose": "Schließen",
  "api.regexEnable": "Regex für diese Suche verwenden",
  "api.regexPattern": "Muster",
  "api.regexGuided": "Geführte Mustersteuerung",
  "api.regexLiteral": "Literal",
  "api.regexAnchors": "Anker",
  "api.regexGroup": "Gruppe",
  "api.regexAlternate": "Alternative",
  "api.regexQuantifier": "Einmal oder öfter",
  "api.regexClass": "Zeichenklasse",
  "api.regexFlags": "Flags",
  "api.regexSample": "Beispieltext",
  "api.regexMatches": "{count} Treffer",
  "api.regexZeroWidth": "Treffer ohne Breite",
  "api.regexCopy": "Muster kopieren",
  "api.regexEngine": "Engine: JavaScript RegExp. Die Auswertung erfolgt lokal und ist auf 512 Muster- und 4.096 Beispielzeichen begrenzt.",
  "api.regexTooLong": "Das Muster darf höchstens 512 Zeichen lang sein.",
  "api.regexInvalid": "Das Muster ist ungültig.",
  // Claude Code inbound
  "nav.claude": "Claude",
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "Kontextgröße überschreiben",
  "claude.maxContextDesc": "Wählen Sie eine begrenzte Vorgabe für neue Claude-Code-Sitzungen. Automatisch nutzt den Client- und Modellstandard; 1000000 fordert 1M an. Ein gespeicherter eigener Wert bleibt verfügbar, bis Sie ihn ersetzen.",
  "claude.maxContextWarn": "Diese Überschreibung deaktiviert die automatische Komprimierung. Ein langer Chat kann das tatsächliche Kontextlimit des Modells erreichen und mit einem Fehler abbrechen.",
  "claude.maxContextAutomatic": "Automatisch (Client- und Modellstandard)",
  "claude.maxContextDefaultProvenance": "Der integrierte Standard Automatisch wird verwendet; in der Konfigurationsdatei ist keine Überschreibung der Kontextgröße gespeichert.",
  "claude.maxContextFileProvenance": "In der opencodex-Konfigurationsdatei für die nächste Claude-Code-Sitzung gespeichert. Eine selbst exportierte Umgebungsvariable hat weiterhin Vorrang.",
  "claude.maxContextDraftProvenance": "Nicht gespeicherte Auswahl. Die Konfigurationsdatei verwendet weiterhin {value}; wählen Sie Speichern, um diese Änderung anzuwenden.",
  "claude.maxContextAutomaticValue": "Automatisch",
  "claude.maxContextInvalidStoredProvenance": "Die Konfigurationsdatei enthält eine ungültige Überschreibung der Kontextgröße. Automatisch wird angezeigt; wählen Sie Speichern, um den ungültigen Wert zu entfernen.",
  "claude.maxContextInvalidStoredValue": "einen ungültigen gespeicherten Wert",
  ...
  "claude.autoContextInert": "Inaktiv, solange „Kontextgröße überschreiben“ gesetzt ist. Wählen Sie oben „Automatisch“, um die Funktion wieder zu aktivieren.",
  ...
  "pws.auth.vertexExternal": "Vertex-Authentifizierung (ADC oder optionaler API-Schlüssel)",
